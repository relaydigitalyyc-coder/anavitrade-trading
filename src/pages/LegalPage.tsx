...
const PRIVACY_CONTENT = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "We integrate with third-party services including Aster (DEX trade execution), WalletConnect (wallet connectivity), and analytics providers. These services have their own privacy policies which govern their use of your data.",
    },
    {
      heading: "6. Cookies",
