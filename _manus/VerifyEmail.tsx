        ...
        >
          {token ? (
            ...
            verified ? (
              <>
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Your account is now active. You can sign in and start setting up your Hyperliquid API wallet.
                </p>
                <Link href="/login">
            ...
            <>
              ...
              <div className="p-4 rounded-2xl bg-card border border-border/50 mb-6 text-left">
